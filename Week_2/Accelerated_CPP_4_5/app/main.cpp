...
/**
 * @brief Reads input stream and stores words to a vector. It uses an
 * unordered_map to simulataneously store the frequency of each word.
 *
 * @param in is the input stream
 * @param words is the vector to store each string (word)
 * @param frequencyCounts is an unordered_map to store the frequency of each
 * word
 *
 * @return void
 */
